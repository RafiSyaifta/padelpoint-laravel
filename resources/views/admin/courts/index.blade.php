        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 flex justify-between items-center text-center sm:text-left">
                <div>
                    ...
                    <p class="text-gray-500 mt-1 font-medium">Tambah, perbarui, atau nonaktifkan lapangan PadelPoint.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden flex flex-col group hover:shadow-xl transition-all duration-300">
                    <div class="relative h-48 bg-indigo-600 overflow-hidden">
                        @if($court->image)
                            <img src="{{ asset('storage/' . $court->image) }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 opacity-90" onerror="this.src='https://via.placeholder.com/400x300?text=No+Image'">
                        @else
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <h3 class="text-xl font-black text-gray-900 mb-4 group-hover:text-indigo-600 transition-colors">{{ $court->name }}</h3>
