    ...
    <div class="pt-8 pb-12 bg-[#F8FAFC] min-h-screen">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-10 lg:p-14">
                <h2 class="text-3xl font-black text-gray-900 mb-8 tracking-tight">Tambah Perlengkapan Baru</h2>

                <form action="{{ route('admin.equipment.store') }}" method="POST" class="space-y-8">
                    @csrf

                    <div class="grid grid-cols-1 gap-8">
                        <div class="space-y-3">
                            <label class="text-sm font-extrabold text-gray-700 uppercase tracking-widest pl-1">Nama Item</label>
                            <input type="text" name="name" class="w-full h-16 rounded-2xl border-gray-200 focus:border-indigo-500 bg-gray-50 font-bold px-6" placeholder="Contoh: Sewa Raket Pro" required>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-3">
                                <label class="text-sm font-extrabold text-gray-700 uppercase tracking-widest pl-1">Harga (Rp)</label>
                                <input type="number" name="price" class="w-full h-16 rounded-2xl border-gray-200 focus:border-indigo-500 bg-gray-50 font-bold px-6" placeholder="Contoh: 30000" required>
                            </div>
                            <div class="space-y-3">
                                ...
                                <select name="type" class="w-full h-16 rounded-2xl border-gray-200 focus:border-indigo-500 bg-gray-50 font-bold px-6">
                                    <option value="rental">Sewa (Per Item)</option>
                                    <option value="purchase">Beli (Per Item)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <textarea name="description" rows="3" class="w-full rounded-2xl border-gray-200 focus:border-indigo-500 bg-gray-50 font-bold px-6 py-4" placeholder="Jelaskan detail item ini..."></textarea>
                        </div>
                    </div>
