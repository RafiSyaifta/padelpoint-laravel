<x-app-layout>
    <div class="pt-8 pb-12 bg-[#F8FAFC] min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(session('success'))
                <div class="mb-8 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-r-2xl shadow-sm">
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.equipment.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus perlengkapan ini?');">
                                            @csrf
                                            @method('DELETE')
