        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                <div>
                    ...
                    <p class="text-gray-500 mt-2 font-medium text-lg">Daftar jadwal lapangan Padel yang sudah kamu pesan.</p>
                </div>
                <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 px-6 rounded-2xl transition-all duration-300 shadow-[0_8px_30px_rgb(79,70,229,0.2)] hover:shadow-[0_8px_30px_rgb(79,70,229,0.4)] hover:-translate-y-1">
            ...
            <div class="space-y-6">
                ...
                @foreach($bookings as $booking)
                        ...
                        <div class="md:w-2/3 p-8 flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                @if($booking->status == 'success')
                                    <span class="inline-block py-1 px-3 rounded-full bg-green-50 border border-green-100 text-[10px] font-black tracking-wider uppercase mb-2 text-green-600">Sukses</span>
                                    ...
                                    <div class="mt-6 p-4 bg-indigo-50/50 rounded-2xl border border-indigo-100">
                                        ...
                                        @else
                                            <div class="flex items-center text-indigo-600 gap-2">
                                                ...
                                                <span class="text-xs font-bold uppercase tracking-tight">Bukti sudah dikirim. Menunggu verifikasi.</span>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                    ...
                    <div id="review-modal-{{ $booking->id }}" class="hidden fixed inset-0 z-[100] overflow-y-auto" style="z-index: 100;">
                        <div class="flex items-center justify-center min-h-screen p-4 text-center">
                            ...
                            <div class="relative bg-white rounded-[2.5rem] shadow-2xl transform transition-all sm:max-w-lg sm:w-full p-10 z-[110] text-left">
                                <form action="{{ route('review.store') }}" method="POST">
                                    ...
                                    <p class="text-gray-500 font-medium mb-8 text-sm leading-relaxed">Review kamu sangat membantu Padelist lain dalam memilih lapangan terbaik.</p>
                                    ...
                                    <div class="mb-8">
                                        <label class="block font-black text-[10px] uppercase tracking-widest text-gray-400 mb-2">Ulasan Kamu</label>
                                        <textarea name="comment" rows="4" class="w-full rounded-xl border-gray-200 bg-gray-50/50 p-4 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900" placeholder="Lapangannya rapi? Lampunya terang? Ceritain dong..."></textarea>
                                    </div>
